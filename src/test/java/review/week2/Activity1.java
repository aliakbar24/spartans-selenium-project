...
import review.week1.RandomNumber;
...
public class Activity1 {
    public static void main(String[] args){
        ...
        - Update phone number and validate success pop up displayed.
        - Your test should work without failing when ran multiple times.
        - Apply implicit and explicit wait.
        - Use any locators available and you prefer.
        - Push to repository.
         */
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("email"))).sendKeys("akbar.ali@gmail.com");
        ...
        String toastText = wait.until(ExpectedConditions.visibilityOfElementLocated
                        (By.cssSelector(".Toastify div.Toastify__toast-body > div:last-child"))).getText();
    ...
    private static String getRandomPhoneNumber() {
        ...
        //Generate 10 random digits and concatenate them to form a 10-digit phone number
